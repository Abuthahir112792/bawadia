          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 text-center">
                <h1 style="color: #00269a;">BAWADi chair maker</h1>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 col-sm-4 mt-paddingbottomxs text-center">
                ...
                <strong class="title" style="color: #00269a;">ADDRESS</strong>
                <address>Suite 18B, 148 Connaught Road Central <br>New Yankee</address>
              </div>
              <div class="col-xs-12 col-sm-4 mt-paddingbottomxs text-center">
                <span class="icon"><i class="fa fa-phone"></i></span>
                <strong class="title" style="color: #00269a;">PHONE</strong>
                <a href="#">+1 (555) 333 22 11</a>
              </div>
              <div class="col-xs-12 col-sm-4 mt-paddingbottomxs text-center">
                <span class="icon"><i class="fa fa-envelope-o"></i></span>
                <strong class="title" style="color: #00269a;">E_MAIL</strong>
