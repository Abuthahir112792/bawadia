...
@section('content')
 ...
 <main id="mt-main">
        ...
        <section class="mt-contact-banner wow fadeInUp" data-wow-delay="0.4s" style="background-image: url(../fronts/images/sq/banner/banner2.jpg);">
          <div class="container">
            <div class="row">
              <div class="col-xs-12 text-center">
                <h1 style="color: #00269a;">ABOUT US</h1>
        ...
        <section class="mt-about-sec wow fadeInUp" data-wow-delay="0.4s">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <div class="txt">
                  <h2 style="color: #00269a;">WHO WE ARE?</h2>
        ...
        <section class="mt-team-sec">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <h3 style="color: #00269a;">OUR TEAM</h3>
                <div class="holder">
                  <!-- col of the Page -->
        ...
        <section class="mt-workspace-sec wow fadeInUp" data-wow-delay="0.4s">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <h2 style="color: #00269a;">OUR WORKSPACE</h2>
              </div>
            </div>
          </div>
          ...
          <ul class="list-unstyled work-slider">
            <li>
              ...
              <div class="img-holder">
                <div class="coll1">
                  <img src="{{asset('fronts/images/sq/product6_img/bawadi_web_SITE-31.jpg')}}" alt="image description">
                </div>
                <div class="coll2">
                  <img src="{{asset('fronts/images/sq/home_img225/bawadi_web_products_size-38.jpg')}}" alt="image description">
                </div>
                <div class="coll3">
                  <img src="{{asset('fronts/images/sq/banner/banner1.jpg')}}" alt="image description">
                </div>
              </div>
            </li>
            <li>
