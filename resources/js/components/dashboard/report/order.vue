		...
		<v-container fluid>
            ...
            <v-row justify="center">
                <v-col cols="6" lg="3" md="3">
                    <DashboardCard :icon="'assignment'" :title="$t('message.dashboard.totalorder')" :data="dashboard.order"  :color="'grey darken-3'" ></DashboardCard>
                </v-col>
				<v-col cols="6" lg="3" md="3">
                    <DashboardCard :icon="'assignment'" :title="$t('message.dashboard.order')" :data="dashboard.ordertoday"  :color="'grey darken-4'" ></DashboardCard>
                </v-col>
				<v-col cols="6" lg="3" md="3">
                    <DashboardCard :icon="'assignment'" :title="$t('message.dashboard.pendingorder')" :data="dashboard.orderpending"  :color="'grey  darken-4'"></DashboardCard>
                </v-col>
				<v-col cols="6" lg="3" md="3">
                    <DashboardCard :icon="'assignment'" :title="$t('message.dashboard.deliverorder')" :data="dashboard.delivered"  :color="'grey  darken-3'"></DashboardCard>
                </v-col>
			</v-row>
			<v-row justify="center">
