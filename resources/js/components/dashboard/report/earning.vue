		...
		<v-container fluid>
            ...
            <v-row justify="center">
                <v-col cols="6" lg="3" md="3">
                    <DashboardCard :icon="'assignment'" :title="$t('message.earning.totalearning')" :data="dashboard.earning"  :color="'blue darken-4'" ></DashboardCard>
                </v-col>
				<v-col cols="6" lg="3" md="3">
                    <DashboardCard :icon="'assignment'" :title="$t('message.earning.earning')" :data="dashboard.earningtoday"  :color="'blue darken-4'" ></DashboardCard>
                </v-col>
				<v-col cols="6" lg="3" md="3">
                    <DashboardCard :icon="'assignment'" :title="$t('message.earning.pendingearning')" :data="dashboard.earningpending"  :color="'indigo  darken-4'"></DashboardCard>
                </v-col>
				<v-col cols="6" lg="3" md="3">
                    <DashboardCard :icon="'assignment'" :title="$t('message.earning.deliverearning')" :data="dashboard.delivered"  :color="'indigo  darken-4'"></DashboardCard>
                </v-col>
			</v-row>
			<v-row justify="center">
...
export default {
	...
	data: () => ({
        ...
        labels: {
         ...
         fields : ['id','contact', 'invoice_prefix','total', 'customer_name','address1', 'city','contact','delivery_agent','email','note', 'branch'],
		headers: [
